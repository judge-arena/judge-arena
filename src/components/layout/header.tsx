...
export function Header({
  ...
  return (
    <header
      className={cn(
        'flex flex-col gap-1 border-b border-surface-200 bg-white px-6 py-4 dark:border-surface-700 dark:bg-surface-800',
        className
      )}
    >
      ...
      <div className="flex items-center justify-between gap-4">
        <div className="min-w-0">
          <h1 className="text-xl font-bold text-surface-900 dark:text-surface-100 truncate">
            {title}
          </h1>
          {description && (
